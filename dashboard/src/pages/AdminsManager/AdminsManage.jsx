...
const [updateVisible , setupdateVisible ]= useState(false);
  ...
  const [idfroupdate , setIdforupdate] = useState(0)
  ...
  const [formDataUpdadte, setFormDataUpdate] = useState({
    username: "",
    email: "",
    password: "",
    fullname: "",
...
const handleEdit = async (admin)  => {
  ...
  const handleSubmit = async (event) => {
    ...
    await axios.post(url + '/addadmin' , formData).then(() => {
      notify("تم اضافة الحساب")
    })
  };

  const handleSubmitupdate = async (event) => {
    event.preventDefault();
    const formDataUpdatesend = {
      ...formDataUpdadte,
      id: idfroupdate,
    };
    // Send the form data to the backend to add/update the admin
    await axios.post(url + '/updateadmin' , formDataUpdatesend).then((res) => {
      console.log(res)
                        ...
                        <div className="flex flex-col mb-2">
                          <div className=" flex flex-row ">
                            <input
                              ...
                              className="m-2 p-2 rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400  text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                              name="username"
                              value={formDataUpdadte.username}
                        ...
                        <div className="flex flex-col mb-2">
                          <div className=" flex flex-row ">
                            <input
                              ...
                              className="m-2 p-2 rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400  text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                              name="password"
                              value={formDataUpdadte.password}
                              onChange={handleInputupdateChange}
                              placeholder="password"
                            />
                          </div>
                        ...
                        <div className="flex flex-col mb-2">
                          <div className=" flex flex-row ">
                            <input
                              ...
                              className="m-2 p-2 rounded-lg border-transparent flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400  text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                              name="fullname"
                              value={formDataUpdadte.fullname}
                              onChange={handleInputupdateChange}
                              placeholder="full name"
                            />
                          </div>
