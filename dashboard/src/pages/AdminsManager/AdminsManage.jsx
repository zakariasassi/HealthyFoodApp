            ...
            <div className="flex flex-col mb-2">
              <div className=" flex flex-row ">
                <input
                  type="text"
                  id="create-account-pseudo"
                  className=" m-2 p-2 rounded-lg border-transparent  appearance-none border border-gray-300 w-2/4 py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                  name="phone"
                  placeholder="+218"
                />
                ...
                <input
                  type="text"
                  id="create-account-pseudo"
                  className="m-2 p-2 rounded-lg border-transparent appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent"
                  name="username"
                  placeholder="email"
                />
              </div>
